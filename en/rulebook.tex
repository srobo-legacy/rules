...
\begin{enumerate}
  \item 2014-11-09: Change rule 1.6 to refer to \emph{match officials} rather than a \emph{judge}.
  \item 2014-11-09: Change the gap between zones (including the barriers) from $300mm$ to $400mm$.
                    This ensures that a flag cannot be in more than one zone, even diagonally.
  \item 2014-11-09: Add rule 1.8 to restrict robots from touching multiple flags.
\end{enumerate}
