...
\begin{enumerate}
  ...
  \item \textbf{1 point} will be awarded for having a token in a slot.
        ...
        A token is deemed to be in a slot if the token's centre of mass lies within the inside bounds of the slot.

  \item \textbf{1 point} will be awarded for each token in an upright orientation anywhere in the arena.
      A token is deemed to be upright if any three of its four lowest corners are part of the bottom face.
      Points will be awarded for upright tokens, even if they are within your robot.
