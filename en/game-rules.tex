...
\begin{enumerate}
  ...
  \item \textbf{1 point} will be awarded for owning a zone.
    ...
    \begin{enumerate}
      ...
      \item A token is deemed to be in a zone if it is on the floor of the arena,
            and the majority of the token is within the inner edge of the line delineating the zone.
    \end{enumerate}
