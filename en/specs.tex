...
\item Each slot is identified by a unique $160mm$ libkoki marker (see section~\ref{sub:markers}).
      ...
      Figure~\ref{fig:arena-zones} shows the which markers identify to which slots.
...
\item The tokens are arranged in order based on the next nearest zone to the token position.
      For example, the tokens to the left of Corner 0 (ie, along the North wall), would be for Corners 0, 1, 3, 2.
      Those to the right of Corner 0 (ie, along the West wall) would be ordered 0, 3, 1, 2.
      This is shown in figure~\ref{fig:arena-dim}.
